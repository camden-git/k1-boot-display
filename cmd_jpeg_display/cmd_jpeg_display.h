...
int fputs(char * __s, FILE * __stream);
undefined jpeg_stdio_src();
undefined cmyk_to_rgb24();
undefined fb_open();
undefined jpeg_destroy_decompress();
undefined jpeg_CreateDecompress();
void free(void * __ptr);
undefined jpeg_std_error();
undefined fb_enable();
undefined fb_close();
int fclose(FILE * __stream);
undefined fb_pan_display();
int fprintf(FILE * __stream, char * __format, ...);
undefined jpeg_read_scanlines();
void * malloc(size_t __size);
undefined jpeg_finish_decompress();
FILE * fopen(char * __filename, char * __modes);
undefined jpeg_read_header();
undefined jpeg_start_decompress();
void exit(int __status);
